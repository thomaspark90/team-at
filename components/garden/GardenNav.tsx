...
// 대시보드 | 필터(운영) | 리뷰·단어·설정 세 그룹으로 구분해 세로선으로 나눈다.
const GROUPS = [
  ...
  [
    ...
    { href: '/garden/beancard', label: '원두카드' },
  ],
  [
  ...
  return (
    <nav className="border-b border-border bg-card/40">
      ...
      <div className="mx-auto flex max-w-[1100px] flex-wrap items-center justify-center gap-x-5 gap-y-1.5 px-4 py-3 sm:px-6">
        {GROUPS.map((tabs, i) => (
          <div key={i} className="flex flex-wrap items-center justify-center gap-x-5 gap-y-1.5">
